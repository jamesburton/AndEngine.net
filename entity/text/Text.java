...
using andengine.opengl.texture.buffer.TextTextureBuffer;
using andengine.opengl.util.GLHelper;
using andengine.opengl.vertex.TextVertexBuffer;
using andengine.util.HorizontalAlign;
using andengine.util.StringUtils;
...
public class Text extends RectangularShape {
	...
	protected void updateText(final String pText) {
		...
		final bool widthsReusable = this.mWidths != null && this.mWidths.length == lineCount;
