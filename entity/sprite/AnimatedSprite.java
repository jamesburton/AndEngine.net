...
public class AnimatedSprite extends TiledSprite : TimeConstants {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public AnimatedSprite animate(final long pFrameDurationEach, final bool pLoop) {
	...
	public AnimatedSprite animate(final long pFrameDurationEach, final bool pLoop, final IAnimationListener pAnimationListener) {
	...
	public AnimatedSprite animate(final long[] pFrameDurations, final bool pLoop) {
	...
	public AnimatedSprite animate(final long[] pFrameDurations, final bool pLoop, final IAnimationListener pAnimationListener) {
	...
	public AnimatedSprite animate(final long[] pFrameDurations, final int pFirstTileIndex, final int pLastTileIndex, final bool pLoop) {
