...
using andengine.util.modifier.SequenceModifier;
using andengine.util.modifier.SequenceModifier.ISubSequenceModifierListener;
...
public class PathModifier extends ShapeModifier {
	...
	public static class Path {
		...
		private int mIndex;
		private bool mLengthChanged = false;
