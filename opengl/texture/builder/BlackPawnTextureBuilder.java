...
using andengine.opengl.texture.BuildableTexture;
using andengine.opengl.texture.BuildableTexture.TextureSourceWithWithLocationCallback;
using andengine.opengl.texture.Texture.TextureSourceWithLocation;
	...
	protected static class Node {
		...
		public Node insert(final ITextureSource pTextureSource, final int pTextureWidth, final int pTextureHeight, final int pTextureSpacing) throws IllegalArgumentException {
			if(this.mChildA != null && this.mChildB != null) {
				...
				final bool fitToBottomWithoutSpacing = textureSourceHeight == rectHeight && rectTop + textureSourceHeight == pTextureHeight;
				final bool fitToRightWithoutSpacing = textureSourceWidth == rectWidth && rectLeft + textureSourceWidth == pTextureWidth;
