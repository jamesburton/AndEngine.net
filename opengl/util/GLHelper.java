...
public class GLHelper {
	...
	private static final bool IS_LITTLE_ENDIAN = (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN);
	...
	public static void enableExtensions(final GL10 pGL, final RenderOptions pRenderOptions) {
		...
		final bool isOpenGL10 = version.contains("1.0");
		final bool isSoftwareRenderer = renderer.contains("PixelFlinger");
		final bool isVBOCapable = extensions.contains("_vertex_buffer_object");
		final bool isDrawTextureCapable = extensions.contains("draw_texture");
