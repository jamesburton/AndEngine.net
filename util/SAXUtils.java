...
public class SAXUtils {
	...
	public static bool getBooleanAttribute(final Attributes pAttributes, final String pAttributeName, final bool pDefaultValue) {
		final String value = pAttributes.getValue("", pAttributeName);
		return (value != null) ? Boolean.parseBoolean(value) : pDefaultValue;
	}

	public static bool getBooleanAttributeOrThrow(final Attributes pAttributes, final String pAttributeName) {
	...
	public static void appendAttribute(final StringBuilder pStringBuilder, final String pName, final bool pValue) {
