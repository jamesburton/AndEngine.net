...
using andengine.util.SimplePreferences;
...
public class LevelStatsDBConnector {
	...
	public void submitAsync(final int pLevelID, final bool pSolved, final int pSecondsElapsed) {
		submitAsync(pLevelID, pSolved, pSecondsElapsed, null);
	}

	public void submitAsync(final int pLevelID, final bool pSolved, final int pSecondsElapsed, final Callback<Boolean> pCallback) {
