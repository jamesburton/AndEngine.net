...
using andengine.util.path.IPathFinder;
using andengine.util.path.ITiledMap;
using andengine.util.path.Path;
...
public class AStarPathFinder<T> : IPathFinder<T> {
	...
	private final bool mAllowDiagonalMovement;
	...
	public AStarPathFinder(final ITiledMap<T> pTiledMap, final int pMaxSearchDepth, final bool pAllowDiagonalMovement) {
		this(pTiledMap, pMaxSearchDepth, pAllowDiagonalMovement, new EuclideanHeuristic<T>());
	}

	public AStarPathFinder(final ITiledMap<T> pTiledMap, final int pMaxSearchDepth, final bool pAllowDiagonalMovement, final IAStarHeuristic<T> pAStarHeuristic) {
	...
	public Path findPath(final T pEntity, final int pMaxCost, final int pFromTileColumn, final int pFromTileRow, final int pToTileColumn, final int pToTileRow) {
		...
		final bool allowDiagonalMovement = this.mAllowDiagonalMovement;
	...
	protected bool isTileBlocked(final T pEntity, final int pFromTileColumn, final int pFromTileRow, final int pToTileColumn, final int pToTileRow) {
	...
	private static class Node : Comparable<Node> {
		// ===========================================================
		// Constants
		// ===========================================================
